#############################################################################
# Makefile for building: PopularCoin-qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: Mon 5. Jan 10:48:13 2015
# Project:  peniche-qt.pro
# Template: app
# Command: c:/Qt/4.8.5/bin/qmake.exe BOOST_INCLUDE_PATH=C:\libs/boost_1_54_0 BOOST_LIB_PATH=C:\libs/boost_1_54_0/stage/lib BOOST_LIB_SUFFIX=-mgw46-mt-1_54 OPENSSL_INCLUDE_PATH=C:\libs/openssl-1.0.1g/include OPENSSL_LIB_PATH=C:\libs/openssl-1.0.1g BDB_INCLUDE_PATH=C:\libs/db-4.8.30.NC/build_unix BDB_LIB_PATH=C:\libs/db-4.8.30.NC/build_unix MINIUPNPC_INCLUDE_PATH=C:\libs/miniupnpc-1.8 MINIUPNPC_LIB_PATH=C:\libs/miniupnpc-1.8 "QMAKE_CXXFLAGS=-fno-guess-branch-probability -frandom-seed=1984 -Wno-unused-variable -Wno-unused-value -Wno-sign-compare -Wno-strict-aliasing" "QMAKE_CFLAGS=-fno-guess-branch-probability -frandom-seed=1984 -Wno-unused-variable -Wno-unused-value -Wno-sign-compare -Wno-strict-aliasing" -o Makefile peniche-qt.pro
#############################################################################
...
Makefile: peniche-qt.pro  ../../Qt/4.8.5/mkspecs/default/qmake.conf ../../Qt/4.8.5/mkspecs/features/device_config.prf \
